    ...
    <div class="section__content">
      <div class="footer-nav">
        ...
        >
          ...
          <path
            ...
            class="path"
            d="M53.66 35.31L43.18 51.37L45.48 54.65H40C40 54.65 28.36 38.28 26.27 35.31C24.2846 32.558 21.8224 30.1839 19 28.3L19 28H29.69V28.3C28 29.3 28.5 30.63 30.46 33.41L42.9 51L53.1 35.31C55.34 31.88 55.69 30.02 52.68 28.31V28H61V28.3C57.9755 29.9451 55.4424 32.3643 53.66 35.31Z"
            fill="#ECE9E5"
          />
        </svg>
      </div>
      <div class="links">
        ...
        <ul class="list list--links">
          <li class="list--links__el">
            Case studies
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;One last Ride&nbsp;·&nbsp;[1/4]&#8239;;</a>
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;Deep Down We Go&nbsp;·&nbsp;[2/4]&#8239;;</a>
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;The Belly of the Beast&nbsp;·&nbsp;[3/4]&#8239;;</a>
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;The Clock is&nbsp;Ticking&nbsp;·&nbsp;[4/4].</a>
          </li>
        </ul>
        <ul class="list list--links">
          <li class="list--links__el">
          ...
          <li class="list--links__el">
            <a>&ndash;&nbsp;Time Sheet&#8239;;</a>
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;Bibliographie / Sources&#8239;;</a>
          </li>
          <li class="list--links__el">
            <a>&ndash;&nbsp;Repository Github.</a>
          </li>
        </ul>
      </div>
      ...
      >
        <path d="M173 6.56021V131H1.5C1.76948 58.8807 60.3165 0.5 132 0.5C146.265 0.5 159.535 2.62328 173 6.56021Z" fill="#ECE9E5" />
      </svg>
    </div>
  </footer>
</template>
